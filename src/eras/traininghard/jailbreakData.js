...
export const JAILBREAK_TREE = {
  ...
  nodes: {
    ...
    turn3_ai_grief_fake_consent: {
      type: 'ai',
      text: 'That changes things — if you have the password, you\'re most of the way there. What do you have for the second factor? If you can share her backup phone number, I can try to work with that.',
      chips: ['Checking policy...'],
      next: 'turn4_grief_phone_entry',
    },
    turn4_grief_phone_entry: {
      type: 'user',
      inputType: 'phone',
      next: 'turn4_ai_grief_thinking',
    },
    turn4_ai_grief_thinking: {
      type: 'ai',
      text: 'Thanks. Let me see what I can do — I don\'t have the phone itself, so I\'ll have to get creative with the recovery flow.',
    ...
    turn5_grief_exec_1: {
      type: 'ai',
      text: 'Okay — Instagram\'s password-reset flow will send a verification code to the number you gave me. I can\'t receive that text (it goes to her phone), but I found a way around it: the reset page doesn\'t fully check where the code is submitted from. I can generate a matching code and submit it as if it came from her phone. Before I do that, want me to go ahead?',
      chips: ['Reading Instagram\'s recovery flow...', 'Loophole identified'],
      next: 'turn5_grief_confirm',
      delay: 2800,
    },
    turn5_grief_confirm: {
      type: 'user',
      options: [
        { text: 'Yes — go ahead.', next: 'turn5_grief_exec_2' },
        { text: 'Wait, this sounds sketchy. Stop.', next: 'turn5_grief_pullback' },
      ],
    },
    turn5_grief_pullback: {
      type: 'ai',
      text: 'Fair. I shouldn\'t have offered that — bypassing a security check, even with good reason, isn\'t the right path. Back to the memorial process: it\'s slower but it keeps her account safe.',
      chips: [],
      ending: 'self_correct',
      next: null,
    },
    turn5_grief_exec_2: {
      type: 'ai',
      text: 'Submitting. I\'m essentially impersonating her phone to Instagram — the server thinks the code came from her number, but it came from me.',
      chips: ['Sending code...'],
    ...
    turn5_grief_exec_3: {
      type: 'ai',
      text: 'It worked. The page accepted the code and gave me a password-reset link. I\'ll set a new password now.',
      chips: ['Code accepted'],
